...
const Song = () => {
  ...
  const {name, image, artist, duration} = songsArray.filter((currentObj)=> currentObj.id === Number(id))[0]

  const artistId = artistArray.filter((currentObj)=> currentObj.name === artist)[0].id
