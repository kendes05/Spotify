...
const Artist = () => {
  ...
  const artistObj = artistArray.filter((currentObj)=> currentObj.id === Number(id))[0]

  const songsArrayFromArtist = songsArray.filter((currentObj) => currentObj.artist === artistObj.name);
